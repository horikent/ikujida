...
class WordsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $param = [
            'word' => '避難訓練',
            'letter' => 'hinannkunnrenn'
        ];
        Word::create($param); 
        $param = [
            'word' => '非認知能力',
            'letter' => 'hininntinouryoku'
        ];
        Word::create($param); 
        $param = [
            'word' => '飛沫感染',
        ...
        $param = [
            'word' => '3ヶ月検診',
            'letter' => '3kagetukennsinn'
        ];
        Word::create($param);    
        $param = [
            'word' => '３歳児検診',
            'letter' => '3saijikennsinn'
        ];
        Word::create($param);    
        $param = [
            'word' => '３歳児検診',
